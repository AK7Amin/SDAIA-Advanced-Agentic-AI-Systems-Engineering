...
> **حالة الأدلة (شفافية)**: أُصلح عيب في سلسلة التجزئة كانت تكسرها العقدة
> المُصدِرة لعدة أحداث (تفصيله في كوميت `fix(security): repair hash-chain`).
> الإصلاح مُثبت باختبار انحدار على مستوى المخطط ضمن مجموعة الاختبارات الخضراء.
> أُزيلت آثار تشغيلات سابقة للإصلاح لأنها مخرجات كود مُستبدَل وتوهم بكسرٍ قائم.
> الالتقاط الكامل النظيف يحتاج تشغيلة واحدة بعد تجدّد الحصة اليومية للنموذج
> المجاني (نفدت أثناء الالتقاط): `python main.py run`.
