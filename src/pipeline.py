...
def process_document(graph, doc_id: str, raw_text: str, guardrails: bool, reports_dir: str | Path, llm=None):
    ...
    return {"doc_id": safe_id, "final_status": status, "guardrails": flags}
