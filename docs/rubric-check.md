...
(الوكلاء منفَّذون كدوال متخصصة تُحقن في المخطط لا ككائنات مستقلة — **قرار
تصميم لا نقص**: الرُبرِك يشترط أدوارًا مسماة تتواصل برسائل منظّمة، وهو محقق
بعقود Pydantic بين خمسة أدوار، والحقن يجعل كل وكيل قابلًا للاستبدال في
الاختبار بلا وراثة ولا حالة مشتركة.)
